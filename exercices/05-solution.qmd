...
Censure par intervalle (nombre connu à une année près, seule l'année du début et le nombre de bilans sont connus des auteurs) et censure à droite (certaines firmes sont encore en activité en 1992 à la fin de la période de collecte de données).
...
3. *Donnez une estimation de la probabilité qu’une entreprise survive 4 ans et demi.*
