slide_buttons <- function(slide_id) {
  glue::glue('<p><a class="btn btn-danger" target="_blank" href="{slide_id}.html"><i class="fa-solid fa-arrow-up-right-from-square"></i> Ouvrir dans une nouvelle fenêtre</a> <a class="btn btn-danger" target="_blank" href="{slide_id}.pdf" role="button"><i class="fa-solid fa-file-pdf"></i> Télécharger au format PDF</a></p>')
}
