...
Plusieurs systèmes de technologies de l'information servent à centraliser les requêtes pour des services. On considère le temps d'attente (en heures, variable `duree`) avant la résolution d'un billet, jusqu'à concurrence de 120 heures.
...
Les données de cette question, extraites de [ResearchBox 159](https://researchbox.org/159) et mises à disposition sous licence [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/), ont servi à construire une échelle psychométrique pour mesurer l'avarice. Les données de $n=300$ participant(e)s ont été collectées à partir de Amazon M'Turk.
