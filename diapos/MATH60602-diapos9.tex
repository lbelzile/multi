...
\begin{document}
\frame{\titlepage}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, enhanced, boxrule=0pt, frame hidden, breakable, sharp corners, interior hidden]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{MATH60602-diapos9_files/figure-beamer/unnamed-chunk-20-1.pdf}
