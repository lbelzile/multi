...
Elle mesure la distance entre deux vecteurs d'observations (deux lignes de la base de données) en se basant sur les variables explicatives.
...
kmoy5 <- kmeans(
   x = donsmult_std, # données
   centers = 5L, # nb groupes
   nstart = 20, # nb initialisation aléatoire
   iter.max = 25)
kmoy5_tab <- donsmult |>
