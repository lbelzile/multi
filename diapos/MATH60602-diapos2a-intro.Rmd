...
.box-1.large[Un panorama de RStudio]
...
.pull-left.center[
<figure>
  <img src="img/01/rstudio-rmd.png" alt="RStudio R Markdown document" title="RStudio R Markdown document" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/01/rstudio-rmd-text.png" alt="RStudio R Markdown text" title="RStudio R Markdown text" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/01/rstudio-rmd-code.png" alt="RStudio R Markdown code" title="RStudio R Markdown code" width="100%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/01/rstudio-rmd-output.png" alt="RStudio R Markdown output" title="RStudio R Markdown output" width="100%">
</figure>
]
...
.box-inv-1["Knit" un document R Markdown en un fichier portable]

.center[
<figure>
  <img src="img/01/rstudio-knit.png" alt="RStudio knit button" title="RStudio knit button" width="70%">
</figure>
]
...
.box-inv-1.sp-after[Combiner **R** et histoire]

.box-1[Nous l'utiliserons en classe:]

.box-1[Je fournis un script]

.box-1[Vous complétez les sections « À votre tour »]

.box-1[À la fin, vous aurez une copie annotée]
...
.box-1[Trouvez ces instructions dans votre carnet et compilez.<br>Quelle est la différence en sortie?]
...
.box-inv-1[Le paquet `tidyverse` est un raccourci<br>pour installer et charger les paquets clés du *tidyverse*]
...
.box-inv-1[Charger un paquet ajoute à l'environnement<br> toutes ses fonctions et données.]
...
# Fonctionalités sans chargement
...
.box-inv-1[Utiliser directement une fonction]
```{r eval=FALSE}
paquet::fonction(...)
```
...
.box-1.large[Objets, classes et types]
...
<table>
  ...
  <tr>
    <td><b>Facteur (<i>factor</i>)</b></td>
    <td>Catégorielle</td>
    <td><code class="remark-inline-code">c("En désaccord", "D'accord", "Neutre")</code></td>
  </tr>
</table>

.box-inv-1[Utiliser la fonction `typeof()`<br> pour déterminer le type d'un vecteur.]
---
...
.box-1.large[Données rectangulaires]
...
.box-inv-1.medium[Les bases de données `data.frame` sont utilisées pour stocker les données (comme un chiffrier)]

--

.box-1[`data.frame`: une liste de variables de type potentiellement différents]
...
.box-1.large[Importer des données]
