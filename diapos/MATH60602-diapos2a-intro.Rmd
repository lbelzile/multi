...
.center[
<figure>
  <img src="img/01/Rlogo.png" alt="Logo de R" title="Logo de **R**" width="30%">
</figure>
]
---
...
.pull-right.center[
<figure>
  <img src="img/01/positron.png" alt="Logo de Positron" title="Logo de Positron" width="100%">
</figure>
...
.box-inv-1.large[Un panorama de Positron]

---


<figure>
  <img src="img/01/positron-normal.png" alt="Positron" title="Interface de Positron" width="100%">
</figure>
...
.pull-left-wide[
<figure>
  <img src="img/01/positron-console.png" alt="Console dans Positron" title="Console dans Positron" width="100%">
</figure>
]
...
.box-inv-1[Tapez votre code, et appuyez sur Retour/Entrée pour le compiler]
]
...
.box-inv-1.medium.sp-after[Utiliser `getwd()` pour trouver l'emplacement]
.box-inv-1.medium[Travailler avec un chemin relatif]

---

class: title title-1
# Dossiers dans Positron

```{r, out.width = '60%',echo=FALSE}
knitr::include_graphics("img/01/positron-dossier.png")
```
...
.pull-left-wide[
<figure>
  <img src="img/01/positron-dossier.png" alt="Panneau fichiers de Positron" title="Panneau fichiers de Positron" width="100%">
</figure>
]
...
.pull-left-wide[
<figure>
  <img src="img/01/positron-dossier.png" alt="Onglet fichiers de Positron" title="Onglet fichiers de Positron" width="100%">
</figure>
]
...
<figure>
  <img src="img/01/positron-source.png" alt="Panneau Source de Positron" title="Panneau Source de Positron" width="80%">
</figure>
]
...
.pull-left[
```{r eval=FALSE}
install.packages("nomdupaquet") 
# Commentaire: sensible à la casse
```
...
```{r echo=FALSE}
countdown(minutes = 2, play_sound = FALSE, font_size = "1.5em")
```
...
.pull-left.center[
<figure>
  <img src="img/01/positron-quarto.png" alt="Posit Quarto document" title="Document Quarto" width="100%">
</figure>
]
...
.box-1[Compilez le bloc de code<br>avec le bouton `Preview`]

.box-1.sp-after-half[(Icône avec triangle, et Preview)]
]
...
.center[
<figure>
  <img src="img/01/quarto-preview.png" alt="Quarto render" title="Compilation de document Quarto" width="70%">
</figure>
]
...
.pull-left[
<figure>
  <img src="img/01/positron-environment.png" alt="Panneau Environnement de Positron" title="Panneau Environnement de Positron" width="100%">
</figure>
]
...
.box-1[Trouvez `four_cyls` dans le panneau Variables<br>Cliquez sur le nom `four_cyls`]
...
.pull-left[
<figure>
  <img src="img/01/positron-data-viewer.png" alt="Positron viewer" title="Positron viewer" width="100%">
</figure>
]

.pull-right[
.box-1[Cliquer sur un objet dans le panneau Variables l'ouvre dans un onglet de visualisation interactive.]
]
...
.pull-left[
<figure>
  <img src="img/01/positron-help.png" alt="Onglet help de Positron" title="Onglet help de Positron" width="100%">
</figure>
]
