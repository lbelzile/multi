...
\begin{document}
\frame{\titlepage}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, frame hidden, sharp corners, breakable, enhanced]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{figures/Lexis_censure.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{figures/lexis_troncationintervalle.pdf}
...
\DocumentationTok{\#\# survdiff(formula = Surv(temps, censure) \textasciitilde{} sexe, data = survie1)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#          N Observed Expected (O{-}E)\^{}2/E (O{-}E)\^{}2/V}
\DocumentationTok{\#\# sexe=0 309      217      181      7.33      16.4}
\DocumentationTok{\#\# sexe=1 191      117      153      8.63      16.4}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#  Chisq= 16.4  on 1 degrees of freedom, p= 5e{-}05}
\end{Highlighting}
\end{Shaded}
