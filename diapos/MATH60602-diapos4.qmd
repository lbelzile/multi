...
On supposera que, au final, chaque client a reçu l'échantillon. Le but de l'exercice rétrospectif est de voir s'il aurait été possible de faire mieux en ne ciblant que ceux susceptibles de donner.
...
Nous utiliserons la pénalisation ou la validation croisée pour choisir notre modèle.
...
Pour ce faire, on pourrait aussi considérer tous les termes quadratiques, et les interactions d'ordre deux:
...
\footnotesize 
Performance sur les 100K données de validation (oracle) des 40 premiers modèles de la procédure séquentielle en fonction du nombre de termes inclus. 
