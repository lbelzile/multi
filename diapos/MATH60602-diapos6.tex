...
\item
  ...
  d'achat toute chose étant égale par ailleurs, avec une cote 285.4\%.
\item
  Inversement, le rapport de cote homme/femme est de 1/3.854=0.259,
\item
  la cote des femmes est 74.1\% inférieure à celle des hommes.
\end{itemize}
\end{frame}
...
Si on voulait le rapport de cote employé vs professionnel, inutile de
réajuster le modèle.
...
Plutôt que de changer la catégorie de référence.
