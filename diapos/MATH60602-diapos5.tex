...
\phantomsection\label{ruxe9gression-logistique}
...
\phantomsection\label{variables-ruxe9ponses-binaires}
...
\phantomsection\label{exemples-de-questions-de-recherches}
...
\phantomsection\label{pourquoi-pas-une-ruxe9gression-linuxe9aire}
...
\phantomsection\label{moduxe8le-linuxe9aire-vs-logistique}
...
\phantomsection\label{pruxe9dicteur-linuxe9aire}
...
\phantomsection\label{fonction-de-liaison}
...
\phantomsection\label{courbe-sigmouxefde}
\begin{center}
...
\phantomsection\label{fonction-de-ruxe9partition-logistique}
On voit que \(p\) est une \textbf{fonction croissante} de
...
\item
  ...
  \(\Pr(Y=1)\) diminue.
\item
  La relation entre \(\Pr(Y=1)\) et \(\eta\) (et donc aussi
  \(\mathrm{X}_{j}\)) est \emph{nonlinéaire}.
\end{itemize}
\end{frame}

\begin{frame}{Rappel exponentiels et logarithme}
\phantomsection\label{rappel-exponentiels-et-logarithme}
...
\phantomsection\label{cote-et-probabilituxe9}
...
cote}
\phantomsection\label{interpruxe9tation-de-lordonnuxe9e-uxe0-lorigine-en-termes-de-cote}
...
\phantomsection\label{interpruxe9tation-en-terme-de-rapport-de-cote}
...
\phantomsection\label{explication}
...
\phantomsection\label{ajustement-du-moduxe8le}
...
\NormalTok{modele1 }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(}\AttributeTok{formula =}\NormalTok{ achat }\SpecialCharTok{\textasciitilde{}}\NormalTok{ format }\SpecialCharTok{+}\NormalTok{ marque,}
...
\phantomsection\label{interpruxe9tation-des-coefficients}
...
\phantomsection\label{vraisemblance-et-estimation-du-moduxe8le}
...
\phantomsection\label{vraisemblance-dune-observation}
...
\phantomsection\label{probabilituxe9-conjointe-duxe9vuxe9nements-binaires}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{log-vraisemblance}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{pruxe9diction-des-probabilituxe9s-de-succuxe8s}
...
\phantomsection\label{test-du-rapport-de-vraisemblance}
\begin{columns}[T]
...
\phantomsection\label{rapport-de-vraisemblance}
...
\phantomsection\label{exemple-de-test}
\footnotesize
...
\phantomsection\label{tester-la-significativituxe9-des-variables}
...
\phantomsection\label{intervalles-de-confiance-pour-coefficients}
...
\phantomsection\label{intervalles-de-confiance}
\begin{figure}
...
\phantomsection\label{tests-et-intervalles-de-confiances}
...
\phantomsection\label{coefficients-pour-donnuxe9es-compluxe8tes}
\footnotesize
...
\phantomsection\label{multicolinuxe9arituxe9}
...
\phantomsection\label{dichotomiser-des-variables-continues}
...
\phantomsection\label{probabilituxe9-de-duxe9passement}
...
\phantomsection\label{moduxe8le-linuxe9aire-et-probabilituxe9-dexcuxe8s}
\begin{figure}
...
\phantomsection\label{probluxe8mes-avec-la-ruxe9gression-logistique}
...
\phantomsection\label{quasi-suxe9paration-de-variables}
...
\NormalTok{quasisep }\OtherTok{\textless{}{-}}\NormalTok{ dbm }\SpecialCharTok{|\textgreater{}}  
...
\phantomsection\label{illustration-de-la-suxe9paration-de-variables}
\begin{center}
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{MATH60602-diapos5_files/figure-beamer/unnamed-chunk-15-1.pdf}
\end{center}
...
\phantomsection\label{coefficients-avec-suxe9paration-de-variable}
...
fonction de \texttt{ymontant} (variable standardisée).}
...
\endlastfoot
cst & \(6.1\) & \(563.1\) \\
ymontant & \(59.0\) & \(1495.6\) \\

\end{longtable}
\end{frame}

\begin{frame}{Causes de la quasi-séparation de variables}
\phantomsection\label{causes-de-la-quasi-suxe9paration-de-variables}
...
\phantomsection\label{solutions-pour-la-quasi-suxe9paration-de-variables}
\begin{enumerate}
\tightlist
\item
...
\phantomsection\label{ruxe9gression-logistique-pour-des-proportions}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{variables-ruxe9ponses-binaires-cumuluxe9es}
...
\phantomsection\label{exemple-succuxe8s-pour-les-examens-de-conduite}
...
\phantomsection\label{ruxe9sumuxe9-de-larticle}
