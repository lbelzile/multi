...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\NormalTok{lasso\_path }\OtherTok{\textless{}{-}} 
\NormalTok{  glmnet}\SpecialCharTok{::}\FunctionTok{glmnet}\NormalTok{(}
    ...
    \AttributeTok{y =}\NormalTok{ dbm\_a}\SpecialCharTok{$}\NormalTok{ymontant,}
    \AttributeTok{alpha =} \DecValTok{1}\NormalTok{, }
    \AttributeTok{lambda =} \FunctionTok{seq}\NormalTok{(}\AttributeTok{from =} \FloatTok{0.01}\NormalTok{, }\AttributeTok{to =} \DecValTok{10}\NormalTok{, }\AttributeTok{by =} \FloatTok{0.01}\NormalTok{))}
\FunctionTok{plot}\NormalTok{(lasso\_path)}
\end{Highlighting}
\end{Shaded}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\NormalTok{lambopt }\OtherTok{\textless{}{-}}\NormalTok{ cv\_output}\SpecialCharTok{$}\NormalTok{lambda.min }\CommentTok{\#ou cv\_output$lambda.1se}
