...
Exemple de base de données marketing. Cibler les clients pour l'envoi
d'un échantillon promotionnel et d'un catalogue de produits.
...
\item
  ...
  de 1000 personnes et regarder le montant d'achat suite à l'envoi.
\item
...
l'échantillon d'apprentissage qui ont acheté suite à l'envoi du
catalogue.
\end{frame}
...
\begin{frame}{Recherche efficace}
...
On peut plutôt opter pour un algorithme glouton (greedy):
...
précédent la variable qui réduit le plus notre critère.
...
qui mène à la plus grande réduction du critère
...
\begin{center}
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{figures/fig-perfo-sequentiel.pdf}
\end{center}
