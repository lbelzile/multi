...
\item
  Sélection du modèle final et prédiction
\end{enumerate}
\end{frame}
...
mieux en ne ciblant que ceux susceptibles de donner.
\end{frame}
...
\FunctionTok{with}\NormalTok{(dbm, }\FunctionTok{table}\NormalTok{(yachat, test))}
\end{Highlighting}
\end{Shaded}
...
quadratiques, et les interactions d'ordre deux:
...
Performance sur les 100K données de validation (oracle) des 40 premiers
modèles de la procédure séquentielle en fonction du nombre de termes
inclus.
