...
- Si la plus grande observation est censurée, la courbe de survie de l'estimateur de Kaplan--Meier n'atteindra pas zéro.
- Si la plus grande observation n'est pas censurée à droite, il est possible d'estimer la moyenne (aire sous la courbe sous la fonction de survie). Autrement, on obtiendra une borne inférieure (sous-estimation de la moyenne).
