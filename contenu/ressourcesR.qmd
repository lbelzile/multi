...
- [Les ressources didactiques listées sur le CRAN](https://cran.r-project.org/other-docs.html) --- voir la section *French*
- [Introduction to **R** and RStudio](https://openintrostat.github.io/oilabs-tidy/01_intro_to_r/intro_to_r.html) par Open Intro Stat
...
- la deuxième édition du livre [**R** for Data Science](https://r4ds.hadley.nz/), qui adhère aux principes du `tidyverse`.
...
lib <- c("remotes", "psych", "glmnet", "caret", 
         "leaps", "car", "caret", "glmbb", "AER",
         "tidyverse", "nnet", "mice", "survminer", 
         "patchwork", "Hmisc", "dbscan",
         "factoextra", "energy", "flexclust",
         "fastcluster", "genieclust", "mclust")
for(pack in lib){
