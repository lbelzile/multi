...
Quelques analyses intéressantes [sur ce blogue](https://runningwithrock.com/berlin-2024/) pour les deux éditions suivantes montrent le genre de comparaisons possibles si on considérait plusieurs éditions. Une analyse exploratoire succincte est disponible [ici](https://www.race-insight.com/en/results/berlin-marathon-2022).
...
3.  À quoi correspondent les trois lettres des codes des pays: est-ce au standard international ISO 3166-1 A-3? Réponse: certaines personnes ont déclaré des pays fantaisistes (souvent plus de trois caractères)
