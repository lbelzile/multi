...
- [Manipulation et visualisation des données de marathon de Berlin](02-activite.qmd)
...
- [Explication de fonctions résumé avec `dplyr` (blog de Andrew Heiss)](https://www.andrewheiss.com/blog/2024/04/04/group_by-summarize-ungroup-animations/)
- [Matériel de cours d'Aurélie Labbe](/files/Intro_R.zip)
- Chapitres [1](https://r4ds.hadley.nz/data-visualize) et [3](https://r4ds.hadley.nz/data-transform) de [***R** for Data Science*](https://r4ds.hadley.nz/)
