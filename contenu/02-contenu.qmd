...
slide_details <- tibble::tribble(
  ...
  "nHbNjowSXko", "Introduction (partie 1)", "1", TRUE,
  "Ull9G_tBoeM", "Introduction (partie 2)", "introb", FALSE,
  "XDGSH7oKrHM", "Manipulations", "manip", FALSE,
  "52P9R5byOnw", "Graphiques", "graphes", FALSE
)
