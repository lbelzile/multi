...
- [**Évaluations**](/evaluations/) ({{< fa pen-ruler >}}): Cette page contient des instructions sur les examens et devoirs.
...
show_table <- function(group_id) {
  ...
  tbl <- schedule_nested$data[[group_id]] |> 
    ...
    kable_styling() |> 
    column_spec(1, width = "40%", extra_css = "padding-right: 20px;") |> 
